...
namespace Ntx.GD
{
	...
	public class GDImport
	{
        ...
        public const string LIBGD = "libgd.dll";
        ...
        [DllImport(LIBGD, EntryPoint = "#68", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi, SetLastError = true)]
        ...
        [DllImport(LIBC, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi, SetLastError = true)]
